        ...
        <div class="cart__block">
          <ul class="cart__orders">
            <li class="cart__order" v-for="item in cartProducts" :key="item.product.id">
              ...
              <b>
                {{ item.product.price }} ₽
                <span style="white-space: nowrap">количество {{ item.amount }} шт.</span>
              </b>
          ...
          <div class="cart__total">
            ...
            <p>
              Итого: <b>{{ cartCountProducts }}</b> товара на сумму <b>{{ cartTotalPrice }} ₽</b>
            </p>
          </div>
...
export default {
  ...
  computed: {
    ...mapGetters({
      cartProducts: "cartDetailsProducts",
